  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      stagesTrackArr.forEach(async (stage, i) => {
        ...
        let positionsObj = {
          id: stage.id,
          positions: stage.positionsArrObj
        };
        ...
        // Positions full
        positionsFullArr.push(stage.positionsArrObj);
       ...
       // if (stagesTrackArray !== null) {
          ...
          stagesTrackArray.forEach(async (stage, k) => {
            ...
            if (trkptStr.length > 0) {
              ...
              // Type
              let typeArr = await exports.getString(stage, "<type>", "</type>");
              trackData["type"] = typeArr[0];
